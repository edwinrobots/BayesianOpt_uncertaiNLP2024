#!/bin/bash
#PBS -N bdl-cooking
#PBS -o ./log/parallel/cooking/interaction_res/baseline.output
#PBS -e ./log/parallel/cooking/interaction_res/baseline.err
...
time python3 main.py --topic cooking --save_dir /work/zu20361/BDL/model/ --model_name vanilla_bert_3epoch_5e-5-16-0.01 --test_mode test --do_test True
